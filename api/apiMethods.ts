...
export const apiMethods = (options?: any) => {
  return {
    ...
    Auth: {
      ...
      changePassword: (body: paths['/api/auth/change-password']['post']['requestBody']['content']['application/json']) => useApi<paths['/api/auth/change-password']['post']['responses']['200']['content']['application/json']>(`/api/auth/change-password`, { method: 'POST', body: body, ...options }),
    },
    Permissions: {
    ...
    Wagon_Scale_Values: {
      ...
      WagonScaleValueController_countByBorder: (query?: paths['/api/wagon-scale-values/customs/by-border']['get']['parameters']['query']) => useApi<paths['/api/wagon-scale-values/customs/by-border']['get']['responses']['200']['content']['application/json']>(`/api/wagon-scale-values/customs/by-border`, { method: 'GET', params: query, ...options }),
      WagonScaleValueController_countBySostav: (query?: paths['/api/wagon-scale-values/customs/import/by-sostav']['get']['parameters']['query']) => useApi<paths['/api/wagon-scale-values/customs/import/by-sostav']['get']['responses']['200']['content']['application/json']>(`/api/wagon-scale-values/customs/import/by-sostav`, { method: 'GET', params: query, ...options }),
      selectBorders: (query?: paths['/api/wagon-scale-values/customs/borders/select']['get']['parameters']['query']) => useApi<paths['/api/wagon-scale-values/customs/borders/select']['get']['responses']['200']['content']['application/json']>(`/api/wagon-scale-values/customs/borders/select`, { method: 'GET', params: query, ...options }),
      selectSostavs: (query?: paths['/api/wagon-scale-values/customs/sostavs/select']['get']['parameters']['query']) => useApi<paths['/api/wagon-scale-values/customs/sostavs/select']['get']['responses']['200']['content']['application/json']>(`/api/wagon-scale-values/customs/sostavs/select`, { method: 'GET', params: query, ...options }),
    ...
    Sse: {
      ...
      SseController_getWagonSessionPings: () => useApi<paths['/api/sse/wagon-session-pings']['get']['responses']['200']>('/api/sse/wagon-session-pings', { method: 'GET', ...options }),
    ...
    WagonSession: {
      ...
      getLastPingRecords: (stationId: string | number) => useApi<paths['/api/wagon-sessions/ping/station/{stationId}']['get']['responses']['200']['content']['application/json']>(`/api/wagon-sessions/ping/station/${stationId}`, { method: 'GET', ...options }),
      getAllLastPingRecords: () => useApi<paths['/api/wagon-sessions/ping/all']['get']['responses']['200']['content']['application/json']>('/api/wagon-sessions/ping/all', { method: 'GET', ...options }),
      ...
      WagonSessionController_createWagonItemFromScreenshot: (id: string | number, body: paths['/api/wagon-sessions/{id}/items']['post']['requestBody']['content']['application/json']) => useApi<paths['/api/wagon-sessions/{id}/items']['post']['responses']['201']>(`/api/wagon-sessions/${id}/items`, { method: 'POST', body: body, ...options }),
      ...
      WagonSessionController_uploadWagonSessionJsonFile: (formData: paths['/api/wagon-sessions/upload-wagon-session']['post']['requestBody']['content']['multipart/form-data'], query?: paths['/api/wagon-sessions/upload-wagon-session']['post']['parameters']['query']) => useApi<paths['/api/wagon-sessions/upload-wagon-session']['post']['responses']['201']>(`/api/wagon-sessions/upload-wagon-session`, { method: 'POST', formData: formData, params: query, ...options }),
      ...
      WagonSessionController_getRailmapWagonStats: (stationCode: string | number, query?: paths['/api/wagon-sessions/railmap/stations/{stationCode}/wagon-stats']['get']['parameters']['query']) => useApi<paths['/api/wagon-sessions/railmap/stations/{stationCode}/wagon-stats']['get']['responses']['200']['content']['application/json']>(`/api/wagon-sessions/railmap/stations/${stationCode}/wagon-stats`, { method: 'GET', params: query, ...options }),
      WagonSessionController_ping: (body: paths['/api/wagon-sessions/ping']['post']['requestBody']['content']['application/json']) => useApi<paths['/api/wagon-sessions/ping']['post']['responses']['201']>(`/api/wagon-sessions/ping`, { method: 'POST', body: body, ...options }),
    },
    Camera: {
      ...
      CameraController_countByCompany: (organizationId: string | number) => useApi<paths['/api/camera/count/by-company/{organizationId}']['get']['responses']['200']['content']['application/json']>(`/api/camera/count/by-company/${organizationId}`, { method: 'GET', ...options }),
    },
    Profile: {
